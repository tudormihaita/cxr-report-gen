...
from cxrclip.modules import load_image_encoder, load_text_decoder
...
class CxrCLIPDecoder(nn.Module):
    def __init__(
        ...
        self.text_decoder = load_text_decoder(model_config["text_decoder"], len(tokenizer), mode="causal")
